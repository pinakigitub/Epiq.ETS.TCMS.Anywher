...
{
    public class MyTextboxField : PageObject
    {
        private const string FIELD_LOCATOR_BY_ID_TEMPLATE = "//my-textbox[@id='{0}']";
        private const string FIELD_INPUT_LOCATOR_BY_ID_TEMPLATE = "//input[@id='{0}']";

        private string fieldId;


        public MyTextboxField(IWebDriver driver, string id) : base(driver, null)
        {
            this.fieldId = id;
        }
